      ...
      <AnimatePresence>
        {toastMsg && (
          <motion.div
            ...
            className="fixed bottom-6 left-1/2 z-[130] w-max max-w-[90vw] -translate-x-1/2 rounded-full border border-(--line) bg-(--card) px-5 py-3 text-sm font-medium shadow-xl"
            role="status"
          >
            {toastMsg}
          </motion.div>
        ...
        {dreamOpen && (
          ...
          >
            <motion.p
              ...
              className="font-display text-[18vw] leading-[0.85] text-transparent"
              style={{
                backgroundImage: "linear-gradient(100deg,#F96E5B,#FFD85E 45%,#C9B7FF)",
